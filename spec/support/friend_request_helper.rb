...
def user_sees_incoming_friend_request_notification(requestee)
  ...
  expect(notification_section).to have_link("accept", href: "/friend_requests/#{requestee.incoming_friend_requests.first.id}/accept")
  expect(notification_section).to have_link("ignore", href: "/friend_requests/#{requestee.incoming_friend_requests.first.id}/ignore")
end
