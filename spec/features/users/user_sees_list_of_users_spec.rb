...
feature "user sees list of other users" do 
  ...
  before(:each) do 
    ...
    @frank = FactoryBot.create(:user, :with_blank_profile, name: "frank", email: "frank@mail.com")
    @john = FactoryBot.create(:user, :with_blank_profile, name: "john", email: "john@mail.com")
